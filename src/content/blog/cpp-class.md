---
title: "C++ 實作 — 一次搞懂類別、物件、繼承"
date: 2020-03-11
tags: ["C++", "教學"]
description: "OOP 核心概念：類別定義、物件實例化、繼承與多型"
---
...
> **TIPS**
> 切記要在繼承之類別前加上**public**宣告，否則會無法取用該類別之屬性
...
> **TIPS**
> 這邊會顯示出兩次是因為第一次是在創建橘子類別時，水果類別的建構子會先執行。但這時候還沒到參數傳入的部分，所以這時候印出來的type跟season會是空的。第二次是在我們使用 **blueorange.Print()** 方法
